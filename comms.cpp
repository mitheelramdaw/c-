...
int main() {
    ...
    while (!raceHasFinished) {
        ...
        // === Enhanced Commentary Block ===
        cout << "\n" << string(60, '=') << "\n";
        if (racerOnePosition > racerTwoPosition) {
            cout << colour(">> COMMENTARY << ", "92;1")
                 << colour(racerOneName, "92") << " " << leadComments[commentDist(randomEngine)] << "\n";
        } else if (racerTwoPosition > racerOnePosition) {
            cout << colour(">> COMMENTARY << ", "96;1")
                 << colour(racerTwoName, "96") << " " << leadComments[commentDist(randomEngine)] << "\n";
        } else {
            cout << colour(">> COMMENTARY << ", "95;1")
                 << tieComments[commentDist(randomEngine)] << "\n";
        }
        cout << string(60, '=') << "\n";
